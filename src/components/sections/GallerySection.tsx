...
const galleryImages: GalleryImage[] = [
  ...
  {
    id: "g14",
    src: "/gallery/14_staircase_moment.jpg",
    alt: "Festive moment together on the staircase",
    rotation: 4,
    tapeColor: "maroon",
    aspectRatio: "portrait",
  },
  ...
  {
    id: "g16",
    src: "/gallery/16_evening_formals.jpg",
    alt: "Evening formal portrait together",
    rotation: 3,
    tapeColor: "amber",
    aspectRatio: "portrait",
  },
  {
    id: "g17",
    src: "/gallery/17_night_stroll.jpg",
    alt: "Nighttime stroll together",
    rotation: -4,
    tapeColor: "maroon",
    aspectRatio: "portrait",
  },
  {
    id: "g18",
    src: "/gallery/18_church_formals.jpg",
    alt: "Dressed up together at a church celebration",
    rotation: 2,
    tapeColor: "cream",
    aspectRatio: "portrait",
  },
